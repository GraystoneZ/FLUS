...
export default function WithdrawCheck ( {tokenFromPar, amountFromPar} ) {
    const protoList = [
    ...
    return (
        <div className="box">
            <h1 className="subtitle">Check Withdraw</h1>
            <div className="field">
            ...
            <div className="field">
                ...
                <div className="control">
                    <div className='select'>
                        <select value={'ETH'} readOnly>
                            <option value={'ETH'} key={0}>{'ETH'}</option>
                        </select>
                    </div>
                </div> 
            </div>
            ...
            <button className='button is-link'>Check</button>
        </div>
    )
}